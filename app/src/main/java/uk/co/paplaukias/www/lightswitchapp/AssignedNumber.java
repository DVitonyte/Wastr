...
public class AssignedNumber {
    ...
    static {
        ...
        // The Light Control, unofficial.
        sAssignedNumbers.put(0x1820, "Light Control");
        sAssignedNumbers.put(0x2A56, "Light Switches Write");
        sAssignedNumbers.put(0x2A58, "Light Switches Read");
